       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                <li>
                       <a href="trader_register.php">Register as Trader</a>
                   </li>
                   ...
                   <li>
                       ...
                       echo "<a href='checkout.php'>  Login &nbsp  </a> ";
                       echo "<a href='Trader/login.php'> |&nbsp Trader Login </a>";
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/logob.png" style = height:60px;,width:198px;  alt="CH_Grocers Logo" class="hidden-xs">
                   <img src="images/logob.png" style = height:60px;,width:198px; alt="CH_Grocers Logo Mobile" class="visible-xs">
